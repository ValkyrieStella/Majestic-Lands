...
if minetest.get_modpath("3d_armor") then
	armor:register_armor("cloud_items:helmet_cloud", {
		...
		groups = {armor_head=1, armor_heal=16, armor_use=90},
	...
	armor:register_armor("cloud_items:chestplate_cloud", {
		...
		groups = {armor_torso=1, armor_heal=19, armor_use=110},
		armor_groups = {fleshy=30},
		damage_groups = {cracky=2, snappy=1, level=6},
	})
		...
		groups = {armor_feet=1, armor_heal=19, armor_use=80, physics_speed=2,
				physics_jump=0.5},
		armor_groups = {fleshy=10},
		damage_groups = {cracky=2, snappy=1, level=6},
	})
	...
	if minetest.get_modpath("shields") then
		armor:register_armor("cloud_items:shield_cloud", {
			...
			groups = {armor_shield=1, armor_heal=19, armor_use=100},
			armor_groups = {fleshy=10},
			damage_groups = {cracky=2, snappy=1, level=6},
		})
