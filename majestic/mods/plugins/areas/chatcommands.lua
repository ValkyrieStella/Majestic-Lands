...
minetest.register_chatcommand("protect", {
	...
	func = function(name, param)
		...
		return true, minetest.chat_send_all(minetest.colorize("#FF00E0","[SYSTEM] "..name.." just protected an area!"))
	end
})
...
minetest.register_chatcommand("set_owner", {
	...
	func = function(name, param)
		...
		return true, minetest.chat_send_all(minetest.colorize("#FF00E0","[SYSTEM] The Admin just added "..ownerName.." to an area! ID: "..id))
	end
})
...
minetest.register_chatcommand("add_owner", {
	...
	func = function(name, param)
		...
		minetest.chat_send_player(ownerName,
				S("You have been granted control over area #@1. "..
				"Type /list_areas to show your areas.", id))
		return true, minetest.chat_send_all(minetest.colorize("#FF00E0","[SYSTEM] "..name.." just added "..ownerName.." to his/her area! ID: "..id))
	end
})
...
minetest.register_chatcommand("rename_area", {
	...
	func = function(name, param)
		...
		areas:save()
		return true, minetest.chat_send_all(minetest.colorize("#FF00E0","[SYSTEM] "..name.." just renamed his/her area to "..newName.."!"))
	end
})
